...
//challenge 2 tambahkan input field html jadi player bisa nentuin score akhir menang.


//make initialize function 


let playerScore,activePlayer,currentScore,dice,flag,winPoint;
winPoint =50;   
...
if (playerScore[activePlayer]>=winPoint){
...
//set winPoint button
function changeWinPoint(){
    winPoint = +(document.getElementById("input1").value);
}
